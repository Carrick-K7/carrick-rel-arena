...
一个“好玩优先、学习次要”的 AI 原生互动剧情游戏。秋雾与徐坤贯穿八关，从第一次邀约、安慰和磨合一路走到关系修复与下一年的家。玩家每关都可选择扮演 25 岁的程序员男生或产品经理女生，互动伴侣自动切换。
...
- 秋雾与徐坤两位角色立绘，随玩家身份选择切换，并由情绪状态驱动演出。
- 火山方舟 Seedream 逐轮剧情图像与 Seedance 结算回忆视频，使用固定人物原型和关键帧保持连续。
